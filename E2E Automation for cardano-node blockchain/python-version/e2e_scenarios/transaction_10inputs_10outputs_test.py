...
from e2e_scenarios.utils import create_payment_key_pair_and_address, calculate_tx_fee, calculate_tx_ttl, send_funds, \
    get_address_balance, wait_for_new_tip, assert_address_balance
...
for i in range(1, len(created_addresses_dict)):
    ...
    transferred_amounts_list.append(int((get_address_balance(src_address) - tx_fee) / (no_of_addr_to_be_created - 1)))
